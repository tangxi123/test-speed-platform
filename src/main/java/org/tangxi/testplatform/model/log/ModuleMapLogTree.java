...
public class ModuleMapLogTree {
    ...
    private List<ModuleMapLogTree> children;
    ...
    public List<ModuleMapLogTree> getChildren() {
        return children;
    }

    public void setChildren(List<ModuleMapLogTree> children) {
